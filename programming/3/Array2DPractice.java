...
public class Array2DPractice
{
  ...
  */
  ...
  {
    for (int row = 0; row < board.length; row++)// board.length is the number of rows  
    {
      for (int column = 0; column < board[0].length; column++)  //board[0].length is the number of columns
      {
